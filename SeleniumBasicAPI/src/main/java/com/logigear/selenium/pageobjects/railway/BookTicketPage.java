...
public class BookTicketPage extends GeneralPage {
	...
	// Methods
	public BookTicketPage bookTicket(String strDepartDate, String strDepartFrom, String strArriveAt, String strSeatType,
			String strTicketAmount) {
		...
		wait.until(ExpectedConditions.presenceOfNestedElementLocatedBy(getCmbDepartFrom(),
				By.xpath("//option[text()='" + strDepartFrom + "']")));
		wait.until(ExpectedConditions.presenceOfNestedElementLocatedBy(getCmbArriveAt(),
				By.xpath("//option[text()='" + strArriveAt + "']")));
		wait.until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(getCmbArriveAt(),
				By.xpath("//option[text()='" + strArriveAt + "']")));
	...
	public String getDepartFromSelectingValue() {
		return this.getCmbDepartFrom().findElement(By.xpath(".//option[@selected='selected']")).getText();
	}

	public String getArriveAtSelectingValue() {
		return this.getCmbArriveAt().findElement(By.xpath(".//option[@selected='selected']")).getText();
	}

	public String getSeatTypeSelectingValue() {
		return this.getCmbSeatType().findElement(By.xpath(".//option[@selected='selected']")).getText();
	}
