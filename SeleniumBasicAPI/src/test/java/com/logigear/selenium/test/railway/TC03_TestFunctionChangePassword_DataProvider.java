...
public class TC03_TestFunctionChangePassword_DataProvider extends Precondition_Invoked {
	...
	public void TC07_TC08(String outMessage, String strUsername, String strCurrentPassword, String strNewPassword,
			String strConfirmPassword, String strExpectedMessage) {
		...
		// FOR: TC08 - User can't change password when \"New Password\" and \"Confirm
		// Password\" are different.
	...
	public Object[][] getDataFromDataprovider() {
		return new Object[][] {
				{ "Involve TC08 - User can change password", Constant.RAILWAY_ACC_MAIL, Constant.RAILWAY_ACC_PASSWORD,
						strTC08NewPassword, strTC08ConfirmPassword,
						"Password change failed. Please correct the errors and try again." },
				{ "Involve TC07 - User can change password", Constant.RAILWAY_ACC_MAIL, Constant.RAILWAY_ACC_PASSWORD,
						strPassword + "updated", strPassword + "updated", "Your password has been updated!" } };
	}
}
