 ...
 * This also involves 
 * TC10 - User can book 1 ticket at a time
 * TC11 - User can book many tickets at a time
 * TC15 - User can filter "Manager ticket" table with Depart Station
 * TC16 - User can filter "Manager ticket" table with Depart Date
...
public class TC05_TestFunctionsBookTicketAndManageticket_DataDriven  extends Precondition{
	...
	public void TC10andTC11(String strTMname, String strDepartDate, String strDepartFrom, String strArriveAt, String strSeatType, String strTicketAmount) {		
		...
		// 5. Select <option value> for "Depart from" and <option value> for "Arrive at".
	...
	public void TC15_TC16(String strTMname, String strFilteredByDepartStation
		...
		String[][] strArrayTicketsAfterFilter = myticketpage
				.filterTickets(strFilteredByDepartStation, strFilteredByArriveStation, strFilteredByDepartDate, strFilteredByByStatus);
				
		// VP: "Manage ticket" table shows correct ticket(s)
		assertTrue(myticketpage.checkTicketsExistInTable(strArrayTicketsBeforeFilter, strArrayTicketsAfterFilter), "Filtered tickets are not correct");
	}
...
//	}
	...
	public void TC17() {
		System.out.println("TC17 - User can't filter \"Manage ticket\" table when choosing value of \"Status\" doesn't exist in \"Manage ticket\" table");
		// 1. Navigate to QA Railway Website	
		HomePage homepage = new HomePage();
		homepage.open();
