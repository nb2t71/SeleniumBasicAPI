...
import com.logigear.selenium.test.Precondition;
...
public class TC01_TestFunctionLogin_DataProvider extends Precondition_Invoked {
	...
	public void TC01_TC02_TC03_TC04_TC06_DataProvider_Invalid(String outMessage, String strUsername, String strPassword,
			int repeatTime, String strExpectedMessage, String strErrorCheckMessage) {
...
//		assertEquals(actualMsg, expectedMsg, "TC04 - Error message is not displayed as expected");
	...
	public Object[][] getDataFromDataprovider() {
		return new Object[][] {
				{ "Involve TC06 - User can't login with account hasn't been activated",
						Constant.RAILWAY_ACC_MAIL_UNACTIVE, "123", 1, "Invalid username or password. Please try again.",
						"TC06 - Error message is not displayed as expected" },
				{ "Involve TC02 - User can't login with blank \"Username\" textbox", Constant.RAILWAY_ACC_MAIL, "", 1,
						"There was a problem with your login and/or errors exist in your form.",
						"TC02 - Error message is not displayed as expected" },
				{ "Involve TC03 - User cannot log into Railway with invalid password", Constant.RAILWAY_ACC_MAIL, "123",
						1, "Invalid username or password. Please try again.",
						"TC03 - Error message is not displayed as expected" },
				{ "Involve TC04 - System shows message when user enter wrong password several times",
						Constant.RAILWAY_ACC_MAIL, 4, "123",
						"You have used 4 out of 5 login attempts. After all 5 have been used, you will be unable to login for 15 minutes.",
						"TC04 - Error message is not displayed as expected" }, };
	}
}
