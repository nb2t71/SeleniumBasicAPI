 ...
 *         with "Confirm password" is not the same as "Password"
 */
...
public class TC02_TestFunctionCreateAccount extends Precondition_Invoked {
	...
	public void TC09() {
		System.out
				.println("TC09 - User can't create account with \"Confirm password\" is not the same as \"Password\"");
		...
		// 3. Enter valid information into all fields except "Confirm password" is not
		// the same as "Password"
		// 4. Click on "Register" button
		registerpage.registNewAccount(strMail, Constant.RAILWAY_PASSWORD, Constant.RAILWAY_PASSWORD + "New",
				Constant.RAILWAY_ACC_PID);
